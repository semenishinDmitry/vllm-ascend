 ...
 * \brief
 */
#ifndef __OP_HOST_FUSED_GDN_L2_RECURRENT_GATED_DELTA_RULE_V310_TILING_H__
#define __OP_HOST_FUSED_GDN_L2_RECURRENT_GATED_DELTA_RULE_V310_TILING_H__

#include "register/tilingdata_base.h"
#include "tiling/platform/platform_ascendc.h"
#include "platform/platform_infos_def.h"
#include "tiling_base/tiling_base.h"
#include "../op_kernel/fused_gdn_l2_recurrent_gated_delta_rule_v310_tiling_data.h"

namespace optiling {
using namespace FusedGdnL2RecurrentGatedDeltaRuleV310;

struct FusedGdnL2RecurrentGatedDeltaRuleV310CompileInfo {
  uint64_t aivNum{0UL};
  uint64_t ubSize{0UL};
};

struct FusedGdnL2RecurrentGatedDeltaRuleV310Info {
 public:
  int64_t usedCoreNum = 0;
  const char* opName = "FusedGdnL2RecurrentGatedDeltaRuleV310";
};

class FusedGdnL2RecurrentGatedDeltaRuleV310Tiling : public Ops::Transformer::OpTiling::TilingBaseClass {
 public:
  explicit FusedGdnL2RecurrentGatedDeltaRuleV310Tiling(gert::TilingContext* context)
      : Ops::Transformer::OpTiling::TilingBaseClass(context) {
    InitCompileInfo();
  };
  ~FusedGdnL2RecurrentGatedDeltaRuleV310Tiling() override = default;
 ...
 protected:
  ...
  using HostRuleFn = ge::graphStatus (FusedGdnL2RecurrentGatedDeltaRuleV310Tiling::*)();
  ...
  ge::graphStatus CheckShapeDimAndRelation(const gert::Shape& queryShape, const gert::Shape& keyShape,
                                           const gert::Shape& valueShape, const gert::Shape& aLogShape,
                                           const gert::Shape& aShape, const gert::Shape& bShape,
                                           const gert::Shape& dtBiasShape, const gert::Shape& stateShape,
  ...
  FusedGdnL2RecurrentGatedDeltaRuleV310CompileInfo compileInfo_;
  FusedGdnL2RecurrentGatedDeltaRuleV310TilingData tilingData_;
  FusedGdnL2RecurrentGatedDeltaRuleV310Info inputParams_;
  UbCalcContext ubCalcCtx_;
  ge::DataType inputDtype_{ge::DT_FLOAT16};
};

}  // namespace optiling
#endif  // __OP_HOST_FUSED_GDN_L2_RECURRENT_GATED_DELTA_RULE_V310_TILING_H__
