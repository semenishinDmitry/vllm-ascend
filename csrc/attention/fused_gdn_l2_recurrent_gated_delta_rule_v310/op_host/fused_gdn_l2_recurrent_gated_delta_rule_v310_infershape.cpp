...
static ge::graphStatus InferShapeFusedGdnL2RecurrentGatedDeltaRuleV310(InferShapeContext* context) {
  if (context == nullptr) {
    OP_LOGE("FusedGdnL2RecurrentGatedDeltaRuleV310", "inference context is null");
...
static ge::graphStatus InferDataTypeFusedGdnL2RecurrentGatedDeltaRuleV310(gert::InferDataTypeContext* context) {
...
IMPL_OP_INFERSHAPE(FusedGdnL2RecurrentGatedDeltaRuleV310)
    .InferShape(InferShapeFusedGdnL2RecurrentGatedDeltaRuleV310)
    .InferDataType(InferDataTypeFusedGdnL2RecurrentGatedDeltaRuleV310);
}  // namespace ops
